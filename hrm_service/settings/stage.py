# settings/stage.py — Stage environment for HRM service
import logging
import os
...
if "hrm-backend-stage" not in ALLOWED_HOSTS:
    ALLOWED_HOSTS.append("hrm-backend-stage")
