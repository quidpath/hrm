...
if os.environ.get("DATABASE_URL"):
    ...
    DATABASES = {
        "default": {
            ...
            "PORT": "5432", "OPTIONS": {"sslmode": "disable"},
        }
    }

DEBUG = False
_default_hosts = "hrm.quidpath.com,api.quidpath.com,quidpath.com,localhost,127.0.0.1,0.0.0.0"
ALLOWED_HOSTS = [h.strip() for h in os.environ.get("ALLOWED_HOSTS", _default_hosts).split(",") if h.strip()]
if "hrm-backend" not in ALLOWED_HOSTS:
    ALLOWED_HOSTS.append("hrm-backend")
