...
class JWTAuthenticationMiddleware:
    ...
    def __call__(self, request):
        ...
        service_secret = os.environ.get("HRM_SERVICE_SECRET") or getattr(settings, "HRM_SERVICE_SECRET", "")
        if service_secret and request.META.get("HTTP_X_SERVICE_KEY", "").strip() == service_secret:
